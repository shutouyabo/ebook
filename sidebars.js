...
const sidebars = {
  ...
  热门杂志: [
...

    {
      ...
      items: [
        'hotzazhi/gsh_zk/BDSM灌肠器道具教学分享',
        'hotzazhi/gsh_zk/基本元器件-电容',
        'hotzazhi/gsh_zk/论文工具收集',
        'hotzazhi/gsh_zk/基本元器件-电感与磁珠',
        'hotzazhi/gsh_zk/基本元器件-二极管',
        'hotzazhi/gsh_zk/基本元器件-晶体三级管',
      ],
    },

    {
      ...
      items: [
        'hotzazhi/gsh_xyb/RobotCtrl-STM32通用开发套件',
        'hotzazhi/gsh_xyb/RobotCtrl_Core-核心板',
        'hotzazhi/gsh_xyb/RobotCtrl_Func-外设拓展板',
        'hotzazhi/gsh_xyb/RobotCtrl_Power-电源供电板',
        'hotzazhi/gsh_xyb/Flip-基于全志F1C200s的Linux开发板',
        'hotzazhi/gsh_xyb/OSD335x最小系统的设计',
        'hotzazhi/gsh_xyb/如何设计一款单片机的最小系统',
        'hotzazhi/gsh_xyb/STM32F4硬件开发',
      ],
    },

    {
      ...
      items: [
        'hotzazhi/sm/TinyDVR-小巧身材，满载动力',
        'hotzazhi/sm/RaptorDVR-集成稳压的30A双电机驱动',
        'hotzazhi/sm/AirForce-充满灵性的电机驱动模块',
        'hotzazhi/sm/ZenDriver-高性能的电机驱动',
        'hotzazhi/sm/电源设计-方案确定',
        'hotzazhi/sm/电源拓扑-线性稳压',
        'hotzazhi/sm/电源拓扑-开关稳压（非隔离型）',
        'hotzazhi/sm/电源拓扑-开关稳压（隔离型）',
        'hotzazhi/sm/电源设计-开关稳压IC（非隔离型）',
        'hotzazhi/sm/电源设计-自举电路',
        'hotzazhi/sm/电源设计-纹波噪声与测量方法',
        'hotzazhi/sm/电源方案（LDO）-XC6206',
        'hotzazhi/sm/电源方案（Buck）-LMR14050',
        'hotzazhi/sm/电源方案（Buck）-TPS54531',
        'hotzazhi/sm/电源方案（Buck）-XL2009E1',
        'hotzazhi/sm/电源方案（Boost）-SX1308',
        'hotzazhi/sm/电源方案（PMIC）-EA3036C',
        'hotzazhi/sm/电源方案（PMIC）-EA3059',
        'hotzazhi/sm/函数思想在电路设计中的应用',
        'hotzazhi/sm/示波器的触发模式',
        'hotzazhi/sm/网络分析仪的使用',
        'hotzazhi/sm/逻辑分析仪的使用',
        'hotzazhi/sm/宽带注入变压器的使用',
        'hotzazhi/sm/线性注入器的使用',
      ],
    },

    {
      ...
      items: [
        'hotzazhi/shenghuo/通信协议-数字逻辑电平',
        'hotzazhi/shenghuo/通信协议-串口通信',
        'hotzazhi/shenghuo/通信协议-SPI',
        'hotzazhi/shenghuo/通信协议-I2C',
        'hotzazhi/shenghuo/通信协议-CAN',
        'hotzazhi/shenghuo/通信协议-USB',
      ],
    },
